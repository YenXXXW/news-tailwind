...
export  async function getServerSideProps(){
    ...
    const res= await fetch('https://bing-news-search1.p.rapidapi.com/news/search?q=Business&freshness=Day&textFormat=Raw&safeSearch=Off', options)
