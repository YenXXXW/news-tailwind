...
function WorldNews({headlines}) {
    ...
    return (
        <div>
            <Head>
                <title> Google News - World News</title>
                <meta name='description' content='google news clone by wai'/>
                <link rel='icon' href='/Google_news_logo.png'/>
            </Head>
...
export  async function getServerSideProps(){
    ...
    const res= await fetch('https://bing-news-search1.p.rapidapi.com/news/search?q=World%20News&freshness=Day&textFormat=Raw&safeSearch=Off', options)
